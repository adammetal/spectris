...
import { addCss, addJs, removeCss, removeJs } from '../../redux/features/injector';
...
function Options() {
  ...
  const handleRemoveCssFile = (file) => {
    dispatch(removeCss(file));
  };

  const handleRemoveJsFile = (file) => {
    dispatch(removeJs(file));
  };
